defmodule ExFix.Serializer do
  ...
  def serialize(%MessageToSend{seqnum: seqnum,
      msg_type: msg_type, sender: sender, orig_sending_time: orig_sending_time,
      target: target, extra_header: extra_header, body: body}, sending_time, resend \\ false) do
    header = case resend do
      false ->
    ...
    {:ok, body, bin_len, cs_total} = fields_to_bin([{@tag_msg_type, msg_type},
      {@tag_seqnum, seqnum} | fields])
