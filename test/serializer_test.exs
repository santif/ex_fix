defmodule ExFix.SerializerTest do
  ...
  test "Message serialization - NewOrderSingle" do
    ...
    assert bin_message ==
             msg(
               "8=FIXT.1.1|9=137|35=D|34=10|49=SENDER|" <>
  ...
  test "Message serialization - Logon" do
    ...
    assert bin_message ==
             msg(
               "8=FIXT.1.1|9=106|35=A|34=1|49=SENDER|" <>
  ...
  test "Message serialization - ASCII" do
    ...
    expected_message =
      msg("8=FIXT.1.1|9=55|35=D|34=10|49=SENDER|" <> "52=20170717-17:50:56.560|56=Dólar|10=171|")
